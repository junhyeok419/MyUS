...
bool CRenderManager::Init()
{
	...
	CreateLayer("Monster", 2);
	CreateLayer("Afterimage", 3);
	CreateLayer("Player", 4);
	CreateLayer("Effect", 5);

	//SetLayerAlphaBlend("Back");
	SetLayerAlphaBlend("Monster");
	SetLayerAlphaBlend("Player");
	SetLayerAlphaBlend("Default");
	SetLayerAlphaBlend("Afterimage");
	...
	//m_DepthDisable = m_RenderStateManager->FindRenderState<CDepthStencilState>("DepthLessEqual");
	return true;
}
